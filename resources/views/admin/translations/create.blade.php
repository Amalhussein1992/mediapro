...
@section('header', 'Create Translation')
    ...
    <div class="bg-white rounded-lg shadow-md">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h3 class="text-xl font-semibold text-gray-800">Create New Translation</h3>
        ...
        <!-- Form -->
        <form action="{{ route('admin.translations.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
