...
<body>
    ...
    <div class="pricing-container">
        ...
        <div class="pricing-card {{ $index === 1 ? 'featured' : '' }}">
            ...
            <div class="plan-price">
                ...
                <span>{{ $subscription->currency ?? 'EGP' }}/شهر</span>
            </div>
            <p class="plan-description">{{ $subscription->description ?? 'خطة مميزة لإدارة حساباتك' }}</p>

            <ul class="plan-features">
                <li><i class="fas fa-check-circle"></i> {{ $subscription->max_accounts ?? 'غير محدود' }} حساب</li>
                <li><i class="fas fa-check-circle"></i> {{ $subscription->max_posts ?? 'غير محدود' }} منشور</li>
                @if($subscription->ai_features)
                ...
                @endif
                @if($subscription->scheduling)
                <li><i class="fas fa-check-circle"></i> جدولة المنشورات</li>
                @endif
                <li><i class="fas fa-check-circle"></i> دعم فني 24/7</li>
            </ul>

            <button class="btn-subscribe" onclick="openPaymentModal({{ $subscription->id }}, '{{ $subscription->name }}', {{ $subscription->price }}, '{{ $subscription->currency ?? 'EGP' }}')">
                اشترك الآن
            </button>
        </div>
        @empty
    ...
    <script>
        ...
        function openPaymentModal(subscriptionId, planName, price, currency) {
